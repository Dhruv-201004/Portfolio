    ...
    () => [
      {
        name: "Email",
        icon: Mail,
        href: "mailto:your.d.raheja2004@gmail.com",
      ...
      },
      {
        name: "LinkedIn",
        icon: Linkedin,
        href: "https://linkedin.com/in/dhruv--raheja",
        color: isDark ? "hover:text-blue-400" : "hover:text-blue-600",
      },
      {
        name: "Codolio",
        icon: CodeSquareIcon,
        href: "https://codolio.com/profile/RiqyqSOF",
        color: isDark ? "hover:text-green-400" : "hover:text-green-600",
      },
    ],
    [isDark]
  );
        ...
        <div className="grid gap-10 items-center">
          ...
          <div className="space-y-8 text-center">
            <div className="space-y-6">
              ...
              >
                Building full-stack web applications with intuitive interfaces
            ...
            >
              <div className="flex flex-wrap gap-4 justify-center pt-8">
                <a
                  href="https://drive.google.com/file/d/1yrAa7vN7A4t9NbcJAROh_jeIuoEPX-d0/view?usp=drivesdk"
                  target="_blank"
