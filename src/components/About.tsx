        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            >
              ...
              >
                <img
                  src="/images/others/profile.webp"
                  alt="Dhruv Raheja"
          ...
          >
            ...
            <div className="space-y-4">
              ...
              >
                ...
                Express.js, React.js, Node.js), with a strong focus on building
                responsive, scalable, and user-centric web applications.
                Passionate about clean code, modular architecture, and modern
                UI/UX design that enhances usability and performance. <br />
                Enthusiastic about transforming ideas into elegant digital
                products using the latest web technologies. Driven by curiosity
                and continuous learning, with a growing interest in data-driven
                development using Python, SQL, and visualization tools.
              </p>
            </div>
