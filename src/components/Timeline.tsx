    ...
    () => [
      {
        ...
        description: [
            "Extracted and processed large datasets using SQL to identify trends and performance metrics",
            "Performed EDA in Python to derive actionable insights and highlight key business patterns",
            "Built interactive Power BI dashboards that streamlined reporting and improved stakeholder decisions"
        ],
      },
      {
        type: "education",
        ...
        description: [
          "Current CGPA: 9.83 - Ranked among top 5% of the cohort",
          "3x Dean's List Awardee for securing GPA > 9.5 consecutively",
          "Strong focus on core Computer Science subjects like DSA, OS, CN, DBMS",
        ],
      },
      {
        type: "education",
        ...
        period: "2022 - 2023",
        description: [
          "Scored 95.6% - School Topper among 150+ students",
          "Recognized for academic excellence in Physics, Chemistry, and Mathematics",
        ],
      },
      {
        type: "education",
        ...
        period: "2020 - 2021",
        description: [
          "Scored 95.8% - Ranked in top 10 out of 180+ students",
          "Awarded for consistent academic performance across all subjects",
        ],
      },
    ],
    []
